...
- `ARCADE_USER_ID` - **Important:** This must match the email address of your signed-in Arcade account. If there is a mismatch, you will get authentication errors when using Arcade tools.
