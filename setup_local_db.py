...
def check_dependencies():
    ...
    try:
        ...
        print("✅ libsql-experimental is installed")
        return True
    except ImportError:
        print("❌ libsql-experimental is not installed")
...
"""
    ...
    print("✅ Created .env file for local SQLite")
    return True


def create_local_database():
    """Create the local SQLite database with required tables."""
    print("\n🗄️  Creating local SQLite database...")
...
def verify_setup():
    ...
    try:
        ...
        print(f"✅ Database contains {count} task(s)")
...
def main():
    """Main setup function."""
    print("=" * 50)
    print("🗄️  Local SQLite Database Setup")
    print("=" * 50)
